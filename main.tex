...
\begin{table*}[!ht]
    ...
    \parbox{\linewidth}{
		...
		\begin{axis}[
			...
			\addplot[black, fill=white, postaction={pattern=north east lines}] table[x=filename, y=r_accuracy, col sep=comma] {products/acc.csv};
			\addplot[red, fill=white, pattern color = red, postaction={pattern=north east lines}] table[x=filename, y=r_bac, col sep=comma] {products/bac.csv};
			\addplot[green, fill=white, postaction={pattern=north east lines}] table[x=filename, y=g_accuracy, col sep=comma] {products/acc.csv};
			\addplot[blue, fill=white, pattern color = red, postaction={pattern=north east lines}] table[x=filename, y=g_bac, col sep=comma] {products/bac.csv};
		\end{axis}
		\end{tikzpicture}
    }
\end{table*}
